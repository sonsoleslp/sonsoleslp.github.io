...
<span><b style="vertical-align:'middle;'">Filter by topic: </b>
<button style='margin-right: 2px; margin-bottom: 2px;' class='btn badge rounded-pill bg-danger cat-badge ' id='badge-la' onclick="filterCat('la')">learning analytics</button>
<button style='margin-right: 2px; margin-bottom: 2px;' class='btn badge rounded-pill bg-danger cat-badge ' id='badge-gbl' onclick="filterCat('gbl')">game-based learning</button>
<button style='margin-right: 2px; margin-bottom: 2px;' class='btn badge rounded-pill bg-danger cat-badge ' id='badge-biblio' onclick="filterCat('biblio')">bibliometrics</button>
</span>
<style>
