...
include-before-body:
  text: |
    ...
    var filterCat = function(name) {
            ...
            var y = document.getElementsByClassName("is-"+name)
...
<!--
<button style='margin-right: 2px; margin-bottom: 2px;' class='btn badge rounded-pill bg-danger cat-badge active' id='badge-la' onclick="filterCat('la')">learning analytics</button>
<button style='margin-right: 2px; margin-bottom: 2px;' class='btn badge rounded-pill bg-danger cat-badge active' id='badge-gbl' onclick="filterCat('gbl')">game-based learning</button>
<button style='margin-right: 2px; margin-bottom: 2px;' class='btn badge rounded-pill bg-danger cat-badge active' id='badge-biblio' onclick="filterCat('biblio')">bibliometrics</button>
