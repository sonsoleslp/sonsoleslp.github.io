...
<p>',Description,'</p>',
ifelse(is.na(Web),'',paste0('<a class="btn btn-success btn-sm" ,="" href="',Web,'" target="_blank" rel="noopener noreferrer" style="margin-right:5px;">
...
ifelse(is.na(Demo),'',paste0('<a class="btn btn-info btn-sm" ,="" href="',Demo,'" target="_blank" rel="noopener noreferrer" style="margin-right:5px;">
